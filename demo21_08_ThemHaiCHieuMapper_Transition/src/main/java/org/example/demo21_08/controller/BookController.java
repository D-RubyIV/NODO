...
public class BookController {
    ...
    @PutMapping(value = "{id}")
    public ResponseEntity<?> update(@PathVariable Integer id, @RequestBody BookDTO dto) throws Exception {
        return ResponseEntity.ok(bookMapper.entityToDTO(bookService.update(id, dto)));
    }
